<head>
    ...
    <!-- Icons -->
    <link rel="stylesheet" href="{{ asset('main/assets/vendor/nucleo/css/nucleo.css') }}" type="text/css">
    <link rel="stylesheet" href="{{ asset('main/assets/vendor/@fortawesome/fontawesome-free/css/all.min.css') }}"
        type="text/css">
    <!-- Argon CSS -->
...
<body class="bg-default">
    ...
    <!-- Argon Scripts -->
    <!-- Core -->
    <script src="{{ asset('main/assets/vendor/jquery/dist/jquery.min.js') }}"></script>
    <script src="{{ asset('main/assets/vendor/bootstrap/dist/js/bootstrap.bundle.min.js') }}"></script>
